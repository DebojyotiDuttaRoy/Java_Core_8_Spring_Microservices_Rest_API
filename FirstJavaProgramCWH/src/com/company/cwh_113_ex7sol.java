...
class MyLibrary {
	...
	public void addBook(Book book) {
		System.out.println("============================================================" + book
				+ "\nThe above mentioned book has been added to the library."
				+ "\n------------------------------------------------------------"
				+ "\nNow the available book list is mentioned below -->");
		this.books.add(book);
	}

	public void issueBook(Book book, String issued_to) {
		System.out.println("============================================================" + book
				+ "\nThe above mentioned book has been issued from the library to " + issued_to + "."
				+ "\n------------------------------------------------------------"
				+ "\nNow the available book list is mentioned below -->");
	...
	public void returnBook(Book b) {
		System.out.println("============================================================" + b
				+ "\nThe above mentioned book has been returned."
				+ "\n------------------------------------------------------------"
				+ "\nNow the available book list is mentioned below -->");
		this.books.add(b);
	}
