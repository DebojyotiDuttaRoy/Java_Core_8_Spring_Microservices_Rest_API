...
public class cwh_29_Practice_Set_6 {
	public static void main(String[] args) {
		...
		System.out.println("Enter the value of the number which we wanna check in the array : ");
		...
		System.out.println("The value of average marks is " + sum / marks3.length);
