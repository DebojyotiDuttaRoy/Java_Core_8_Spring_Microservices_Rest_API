...
public class cwh_103_ex6sol {
	public static void main(String[] args)
		 ...
		 * which throws the following exceptions: 1. Invalid input Exception ex: 8 & 9
		 * 2. Cannot divide by 0 Exception 3. Max Input Exception if any of the inputs
		 * is greater than 100000 4. Max Multiplier Reached Exception - Don't allow any
		 * multiplication input to be greater than 7000
		 */
